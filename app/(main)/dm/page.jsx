...
export default function DMListPage() {
    ...
    return (<div className="flex-1 flex flex-col items-center justify-center bg-[var(--bg-primary)] p-8">
      <div className="max-w-md text-center">
        ...
        {channels.length > 0 && (<p className="mt-6 text-sm text-[var(--text-muted)]">
