export const API_ROUTES = {
    ...
    SERVERS: {
        ...
        MEMBERS: (serverId) => `/api/v1/servers/${serverId}/members`,
        MEMBER: (serverId, userId) => `/api/v1/servers/${serverId}/members/${userId}`,
        BANS: (serverId) => `/api/v1/servers/${serverId}/bans`,
        BAN: (serverId, userId) => `/api/v1/servers/${serverId}/bans/${userId}`,
        ROLES: (serverId) => `/api/v1/servers/${serverId}/roles`,
        ROLE: (serverId, roleId) => `/api/v1/servers/${serverId}/roles/${roleId}`,
        INVITES: (serverId) => `/api/v1/servers/${serverId}/invites`,
    },
    CHANNELS: {
        BY_SERVER: (serverId) => `/api/v1/servers/${serverId}/channels`,
        BY_ID: (id) => `/api/v1/channels/${id}`,
        MESSAGES: (channelId) => `/api/v1/channels/${channelId}/messages`,
    },
    MESSAGES: {
