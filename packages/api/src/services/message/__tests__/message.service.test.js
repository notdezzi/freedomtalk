...
describe('MessageService', () => {
    ...
    describe('updateMessage', () => {
        ...
        it('should throw NotFoundError for non-existent message', async () => {
            await expect(messageService.updateMessage('nonexistent', 'New content', testUserId)).rejects.toThrow(NotFoundError);
        });
        it('should throw ConflictError for deleted message', async () => {
            ...
            await messageService.softDeleteMessage(message.id, testUserId);
            await expect(messageService.updateMessage(message.id, 'New content', testUserId)).rejects.toThrow(ConflictError);
        });
    });
