...
export function Modal({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "w-full bg-[var(--surface-overlay)] rounded-lg shadow-[var(--shadow-elevation-high)]",
          "animate-scale-in",
          sizes[size],
          className
        )}
      ...
      >
        {(title || showCloseButton) && (
          <div className="flex items-center justify-between p-4 border-b border-[var(--border-default)]">
            {title && (
              <h2
                id="modal-title"
                className="text-lg font-semibold text-[var(--header-primary)]"
              >
                {title}
              </h2>
            )}
        ...
        {description && (
          <p
            ...
            className="px-4 pt-4 text-sm text-[var(--header-secondary)]"
          >
            {description}
          </p>
        )}
