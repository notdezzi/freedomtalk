              ...
              <div className="p-3 rounded bg-error/10 border border-error/20">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 rounded text-sm bg-background-surface hover:bg-background transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="px-3 py-1.5 rounded text-sm bg-error text-white hover:bg-error/80 transition-colors"
                  >
                    Delete
                  </button>
                </div>
