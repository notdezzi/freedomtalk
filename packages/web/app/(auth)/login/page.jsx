    ...
    return (<div className="w-full max-w-md">
      <div className="bg-[#313338] rounded-lg shadow-lg p-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-[var(--text-muted)]">We&apos;re so excited to see you again!</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="relative">
            <Input {...register("password")} type={showPassword ? "text" : "password"} label="Password" placeholder="Enter your password" error={errors.password?.message} icon={<Lock className="w-5 h-5"/>} disabled={isLoading}/>
        ...
        <div className="space-y-3">
          <Button type="button" variant="secondary" fullWidth onClick={() => handleOAuthLogin("google")} disabled={isLoading}>
          ...
          <Button type="button" variant="secondary" fullWidth onClick={() => handleOAuthLogin("github")} disabled={isLoading}>
